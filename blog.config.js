...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'OF Hardware', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Engineered to Endure by OFHardware', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ofhardware.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'hardware, hinges, door hinges, China, OEM', // 网站关键词 英文逗号隔开
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '5679690673', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '2215938443', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '4366609007', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '2987106393', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
...
//    'Hi，我是一个喜欢数码、喜欢折腾的非程序员, 欢迎来到我的站点🎉，我喜欢分享智能家居、游戏、AI、编程等方面的内容。',
