...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AI Innovation', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '喜欢搞技术的一个人👨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://inno4ai.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Innovation, 博客, AI, Tech, Game, 游戏, 科技, 高科技', // 网站关键词 英文逗号隔开
